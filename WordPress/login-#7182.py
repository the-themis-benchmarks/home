...
if __name__ == '__main__':
    ...
    wait()
    out = d(className="TextInputLayout", text="Username").child(className="android.widget.EditText").set_text("testkkksite")
    if out:
        print("SUCCESS: input user name")

    wait()
    out = d(className="TextInputLayout", text="Password").child(className="android.widget.EditText").set_text("W11j141993")
    if out:
