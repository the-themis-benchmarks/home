...
if __name__ == '__main__':
    ...
    d.app_stop("com.nextcloud.client")
    wait()
    ...
    wait()
    out = d(className="android.widget.EditText", resourceId="user").set_text("droid_fuzzing_9@163.com")
    if out:
        print("SUCCESS")
    ...
    wait()
    # out = d(className="android.widget.Button", text="授权访问").click()
